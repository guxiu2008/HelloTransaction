 ...
 **/
public class TrasactionAnnotationTestApp {
    public static void main(String[] args) {
        ApplicationContext applicationContext = new ClassPathXmlApplicationContext("transactionAnnotation/applicationContext.xml");
        // 获取AccountDao实例
        AccountTransferDao accountTransationDao = (AccountTransferDao) applicationContext.getBean("accountTransationDao");
        // 调用实例中的转账方法
        accountTransationDao.transferAnnotation("Eva", "guxiu", 100.0);
        // 输出提示信息
